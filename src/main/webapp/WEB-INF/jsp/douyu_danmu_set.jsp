...
<link rel="stylesheet" href="/assets/css/core.css" />
					...
					<!-- Row start -->
						<div class="am-u-sm-12">
							<div class="card-box">
								...
								<h4 class="header-title m-t-0 m-b-30">斗鱼直播间设置(多个直播间请,分隔)</h4>
								
								<div class="am-g">
									<div class="am-u-md-6">
										<form class="am-form am-text-sm" action="${pageContext.request.contextPath}/douyu/danmu/setDyDanMu">
										    <div class="am-form-group">
										    	<div class="am-g">
											      <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ta-1">直播间url</label>
											      <textarea id="url_area" class="am-u-md-10 form-control" rows="5" id="doc-ta-1" name="url"></textarea>
										    	</div>
												<button type="button" onclick="sub()" class="am-btn am-btn-primary">保存</button>
										    </div>
										</form>
									</div>
								</div>
			...
			<div class="am-g">
				<div class="am-u-md-6">
					<form class="am-form am-text-sm">
						<div class="am-form-group">
							<button type="button" onclick="startPro()" class="am-btn am-btn-primary">启动后台弹幕进程</button>
							<button type="button" onclick="stopPro()" class="am-btn am-btn-primary">停止后台弹幕进程</button>
						</div>
					</form>
				</div>
			</div>
	...
	<script type="text/javascript">
		function sub() {
            $.ajax({
                url: "/douyu/danmu/setDyDanMu",
                type: "GET",
                data: {"url": $("#url_area").val()},
        ...
        function startPro() {
            $.ajax({
                url: "/douyu/danmu/DyDanMuProcess",
                type: "GET",
                data: {"action": 0},
                //dataType: "jsonp",  //指定服务器返回的数据类型
                //jsonp: "callback",
